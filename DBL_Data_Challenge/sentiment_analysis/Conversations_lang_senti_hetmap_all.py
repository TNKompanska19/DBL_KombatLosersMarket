...
for node in G.nodes:
    ...
    language = G.nodes[node].get("language")
...
ax.set_title('Sentiment Distribution by Language (Top 10)', fontsize=14)

plt.tight_layout()
plt.savefig("sentiment_heatmap_language_fullnames2_user.png", dpi=300, bbox_inches="tight")
plt.show()