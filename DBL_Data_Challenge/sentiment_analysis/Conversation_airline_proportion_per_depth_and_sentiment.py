...
# Optional: Limit the analysis to a maximum depth
...
plt.title('Airline Engagement and Sentiment by Conversation Depth', fontsize=16)
fig.tight_layout()
...
plt.savefig("proportion_vs_sentiment_by_depth.png", dpi=300, bbox_inches="tight")
plt.show()